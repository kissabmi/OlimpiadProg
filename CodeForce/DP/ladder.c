...
//массив заполнили маленькими числами т.к ищем максимум. Это гарантирует, что любые реальные суммы будут больше начальных значений.
...
/* 3 СЛУЧАЙ РЕШЕНИЯ (рекурсия с мемоизацией)
